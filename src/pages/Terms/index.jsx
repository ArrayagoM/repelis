      ...
      <div className="max-w-3xl mx-auto px-6 md:px-12">
        ...
        <article className="prose-content space-y-7 text-muted text-sm leading-relaxed">
          <Section title="1. Aceptación de los términos">
            Al usar Life High aceptás estos términos en su totalidad. Si no estás de acuerdo con
            alguno de los puntos, te pedimos que no uses el servicio.
          </Section>

          <Section title="2. Naturaleza del servicio">
            Life High es un <strong className="text-chalk/85">agregador de enlaces</strong>. La aplicación
            ...
            entre otros). <strong className="text-chalk/85">Life High no aloja, almacena, codifica ni transmite
          ...
          <Section title="3. Uso aceptable">
            ...
            Life High se ofrece "tal cual" con fines informativos y educativos. Cualquier uso que vulnere
            derechos de autor es responsabilidad exclusiva del usuario.
          </Section>

          <Section title="4. Ausencia de cuentas y datos personales">
            Life High no requiere registro. No recolectamos correos, contraseñas, números de teléfono ni
          ...
          <Section title="5. Disponibilidad y garantías">
            ...
            cambiar de URL o dejar de funcionar sin aviso. Life High no garantiza disponibilidad continua,
            calidad de reproducción ni existencia de un título específico.
          </Section>

          <Section title="6. Reclamos por contenido (DMCA / takedown)">
            Si sos titular de derechos sobre una obra y considerás que un enlace indexado por Life High
            ...
            <ol className="list-decimal list-inside mt-2 space-y-1 marker:text-gold/60">
              ...
              <li>Si querés que Life High <strong className="text-chalk/85">no indexe</strong> un título puntual, escribinos al canal de contacto del proyecto TinTech con: título, año, ID de TMDB y prueba de titularidad.</li>
          ...
          <Section title="7. Publicidad de terceros">
            ...
            Life High <strong className="text-chalk/85">no recibe ingresos</strong> por esa publicidad y no
            tenemos control sobre ella. Recomendamos usar un bloqueador de anuncios.
          </Section>

          <Section title="8. Limitación de responsabilidad">
            Life High y TinTech no son responsables por: daños derivados del uso del servicio, pérdida de
          ...
          <Section title="10. Jurisdicción">
            Cualquier disputa relacionada con el uso de Life High se resolverá bajo las leyes de la
          ...
          <Section title="11. Contacto">
            ...
            GitHub o redes asociadas listadas en <Link to="/about" className="text-gold hover:underline">la página Sobre Life High</Link>.
          </Section>
        </article>
      </div>
    </motion.main>
